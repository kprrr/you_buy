...
<div region="center">
    ...
    <div id="menus" style="height: auto">
        <a href="javascript:;" id="add" class="easyui-linkbutton"
           data-options="iconCls:'icon-add',plain:true">新建</a>
        <a href="javascript:;" id="edit" class="easyui-linkbutton"
        ...
        <a href="javascript:;" id="btn_arti" class="easyui-linkbutton"
           data-options="iconCls:'icon-search',plain:true">查看帮会建筑</a>


        <a href="javascript:;" id="btn_game" class="easyui-linkbutton"
           data-options="iconCls:'icon-search',plain:true">查看帮会游戏</a>

        <a href="javascript:;" id="btn_user" class="easyui-linkbutton"
           data-options="iconCls:'icon-search',plain:true">查看帮会成员</a>
