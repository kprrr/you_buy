...
<form id="form" class="panl" method="post">
	<table border="0" width="100%" cellpadding="5" cellspacing="1"
		...
		<tr>
			...
			<th>
				<select class="easyui-combobox"
					...
					<option value="玩赚天地" selected="selected">玩赚天地</option>
                    <option value="玩赚世界" selected="selected">玩赚世界</option>
        ...
        <tr>
            ...
            <th>
                <input id="finishtimes" name="finishtimes" class="easyui-numberspinner"
                       style="width: 100%" required="required"
                       data-options="min:0,max:99999999,precision:0" value="0">
            </th>
        </tr>
