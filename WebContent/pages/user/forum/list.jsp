...
<div region="center">
    ...
    <div id="menus" style="height:auto">
        ...
        <a href="javascript:;" id="btn_result" class="easyui-linkbutton"
           data-options="iconCls:'icon-search',plain:true">查看回帖</a>
        <a href="javascript:;" id="btn_tops" class="easyui-linkbutton"
           data-options="iconCls:'icon-redo',plain:true">置顶</a>
    </div>
</div>
