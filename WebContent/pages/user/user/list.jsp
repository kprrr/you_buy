    ...
    <fieldset>
        ...
        <table border="0" cellpadding="5" cellspacing="1" class="table_bg">
            <tr>
                ...
                <td>在线状态:</td>
                <th>
                    <select class="easyui-combobox" data-options="panelHeight: 'auto',editable:false" id="s_op"
                            style="width:100px;">
                        <option value="">全部</option>
                        <option value="on">在线用户</option>
                        <option value="off">下线用户</option>
                    </select>
                </th>
                <th>
...
<div region="center">
    ...
    <div id="menus" style="height:auto">
        ...
        <a href="javascript:;" id="reload" class="easyui-linkbutton"
          ...
          <a href="javascript:;" id="btn_score_record" class="easyui-linkbutton"
				data-options="iconCls:'icon-search',plain:true">查看积分兑换记录</a>

		 <a href="javascript:;" id="btn_fan" class="easyui-linkbutton"
		data-options="iconCls:'icon-search',plain:true">查看用户粉丝</a>
        <a href="javascript:;" id="btn_gang" class="easyui-linkbutton"
           data-options="iconCls:'icon-search',plain:true">查看所属帮会</a>
